...
public class Tictactoe { 
  public static void main(String[] args) {
	  new LaunchGame();
	  HumanPlayer p1 = new HumanPlayer("Deva",'X');
	  AIPlayer p2 = new AIPlayer("CAI",'O');
	  Player cp;
	  cp = p1;
	  ...
	  while(true) 
	  {
		  ...
		  cp.makeMove();
		  LaunchGame.dispBoard();
		  if(LaunchGame.checkColWin() || LaunchGame.checkRowWin() || LaunchGame.checkDiaWin())
		  {
